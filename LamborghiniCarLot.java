...
public class LamborghiniCarLot
{
    ...
    /**
     * non-default constructor for LamborghiniCarLot
     * @param lotName the name of the LamborghiniCarLot
    ...
    /**
     * returns the number of Lamborghinis in the inventory between the parameters (inclusive)
     * @param startYear the lower boundary year
     * @param endYear the upper boundary year
     * @return the number of Lamborghini objects in the inventory between the parameters
     */
    ...
    /**
     * returns true if the model exists in the inventory, returns false if modelName not found or inventory is empty
     * @param modelName the model name of the car
     * @return true if the car model name exists in the inventory 
     */
    ...
    /**
     * returns the average horsepower of all objects that match modelYear parameter
     * @param modelYear the year parameter
     * @return the average horsepower for all objects that match modelYear returns 0.0 if not objects match the specified year
     */
    ...
    /**
     * returns the number of cars in an inventory
     * @return the number of objects in inventory
     */
